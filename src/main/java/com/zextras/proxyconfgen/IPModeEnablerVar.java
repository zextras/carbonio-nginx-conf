...
abstract class IPModeEnablerVar extends com.zextras.proxyconfgen.ProxyConfVar {
  ...
  static IPMode getZimbraIPMode() {
    if (currentIPMode == IPMode.UNKNOWN) {
      String res = com.zextras.proxyconfgen.ProxyConfVar.serverSource.getAttr(ZAttrProvisioning.A_zimbraIPMode, "both");
