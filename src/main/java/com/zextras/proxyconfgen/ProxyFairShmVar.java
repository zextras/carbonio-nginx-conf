...
class ProxyFairShmVar extends com.zextras.proxyconfgen.ProxyConfVar {
  ...
  public ProxyFairShmVar() {
    super(
        ...
        "",
        com.zextras.proxyconfgen.ProxyConfValueType.CUSTOM,
        com.zextras.proxyconfgen.ProxyConfOverride.CONFIG,
