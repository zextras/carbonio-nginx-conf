...
class ZMLookupHandlerVar extends com.zextras.proxyconfgen.ProxyConfVar {
  ...
  public void update() throws ServiceException, com.zextras.proxyconfgen.ProxyConfException {
      ...
      for (String handlerName : handlerNames) {
        ...
        if (s != null) {
          ...
          if (isTarget) {
            ...
            } catch (com.zextras.proxyconfgen.ProxyConfException pce) {
              numFailedHandlers++;
    ...
    if (servers.isEmpty()) {
      if (numFailedHandlers > 0) {
        throw new com.zextras.proxyconfgen.ProxyConfException("No available nginx lookup handlers could be contacted");
      } else {
